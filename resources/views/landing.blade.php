...
<head>
    ...
    <title>{{ config('app.name', 'Laundry Queen') }}</title>
        ...
        <div class="container p-5">
            <div class="row">
                <div class="col-md-6 mb-4 mb-sm-0">
                    <h5>Alamat</h5>
                    <p>Jalan Permata Cikarang Timur no 10</p>
                    <br>
                    <h5>Kontak</h5>
                    <p>laundryqueen@gmail.com</p>
                    <p>082284804545</p>
                    <p>087742398225</p>
                </div>
                <div class="col-md-6">
                    <!-- <iframe
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d991.4433416997157!2d107.18586700043689!3d-6.2934877595117245!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1spermata%20cikarang%20timur!5e0!3m2!1sid!2sid!4v1720017136777!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="true" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
